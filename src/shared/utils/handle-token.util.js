...
/**
 * Genera un access token que permite acceder a un recurso protegido
 * @param {object} payload Representa la informacion del usuario que se quiere autenticar
 * @returns {string}  Retorna el access token
 */
 ...
 * @param {object} payload Representa la informacion del usuario que se quiere autenticar
 * @returns {string}  Retorna el refresh token
*/
